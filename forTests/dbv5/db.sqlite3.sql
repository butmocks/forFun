...
VALUES (
    3,
    'Вибравши саму соковиту полуничку, той, хто фантує, бере її в губи і пригощає другого гравця. Той ласує неквапливо, розтягуючи насолоду від процесу і повільними шматочками відкушуючи від дивовижного частування. Наступну ягоду бере в губи другий гравець і тепер він пригощає фантуючого. Якщо не дай боже, всю полуницю підло з''їла покоївка, вам доведеться перейти на банан. У цьому випадку, очистивши його, ви починаєте одночасно, з двох боків поїдати фрукт назустріч один одному. Коли губи стикнуться, ви закушує свій десерт ніжним французьким поцілунком.',
    1,
    NULL,
    1
  );
...
VALUES (
    4,
    'Дівчина відверто розповідає, чи було її життя таке, коли хтось сторонній бачив, як вона займається сексом. Вона описує ту пікантну історію в деталях та подробицях, згадуючи, що випробувала при цьому, злякалася чи навпаки, ще більше збудилася. «Вдячний слухач» може випитувати панночку про всі тонкощі і нюанси того, що відбувалося, щиро співпереживаючи бідолашній, що потрапила в таку непристойну історію. Одкровення дівчини винагороджується ніжним поцілунком у губки.',
    1,
    NULL,
    1
  );
...
VALUES (
    5,
    'Взявши долоню дівчини, чоловік присувається до неї ближче. Заплющивши очі і розслабившись, панночка розповідає, які відчуття вона відчуває під час наростання сексуального збудження, що відчуває і переживає, чого їй при цьому хочеться найбільше, яких ласок, дотиків, дій.',
    1,
    NULL,
    1
  );
...
VALUES (
    6,
    'Фантуючий розповідає про еротичний фільм, що запам''ятався йому, можливо трохи прикрашаючи і доповнюючи його. Він докладно описує найромантичніші сцени і яскраво ілюструє найсексуальніші епізоди. При цьому особливу увагу намагається приділити почуттям та переживанням героїв, їх емоціям та відчуттям. Вислухавши цей захоплюючий спогад, другий гравець фантазує, що він доповнив або змінив у сюжеті, якби був на місці режисера фільму або писав його сценарій. Немає бажання на наступному побаченні подивитися вдвох цей цікавий фільм, затишно влаштувавши диванчик?',
    1,
    NULL,
    1
  );
...
VALUES (
    8,
    'Чоловік цілує руку дівчині. Спочатку він робить це як партнера з бізнесу, потім - з ввічливості, потім - як шанувальник співачки і, нарешті, - як коханець своєї обраниці.',
    1,
    NULL,
    1
  );
...
VALUES (
    10,
    'Чоловік притискає вухо до грудей дівчини та уважно слухає, як б''ється її серце. У цьому, засікаючи час, він розраховує її пульс. Закінчивши "обстеження", він цілує їй.',
    1,
    NULL,
    1
  );
...
VALUES (
    11,
    'Гравці, тримаючись за руки і ніжно дивлячись у вічі, почергово говорять один одному компліменти романтичного характеру. Починає чоловік. У цьому компліменти нічого не винні повторюватися, але в роздуми дається трохи більше десяти секунд. Той, хто скаже їх більше, не поспішаючи і чуттєво знімає з іншого одну частину одягу, а потім ніжно цілує його в губи.',
    1,
    NULL,
    1
  );
...
VALUES (
    12,
    'Фантуючому зав''язують очі, а другий гравець дбайливо і грайливо годує його зі своїх рук ягодами, фруктами та солодощами, поки той не насититься. Після цього він дає йому запити ці ласощі ковтком вина зі свого рота. На подяку фантуючий говорить партнеру вишуканий романтичний комплімент.',
    1,
    NULL,
    1
  );
...
VALUES (
    14,
    'Дівчина розповідає, який чоловічий одяг, і особливо нижню білизну, вона вважає найбільш привабливою та спокусливою. Яким чином одягнений (або роздягнений) чоловік здається їй більш сексуальним. Докладно зупиняючись на деталях та особливостях, вона описує, у чому хотіла б побачити сьогоднішнього свого партнера, включаючи нижню білизну. Розмірковуючи вголос, немов режисер жіночого клубу, вона фантазує, наскільки спокусливо він виглядатиме, як еротично підкреслить його фігуру така білизна. Завершивши своє захоплююче оповідання, дівчина ніжно цілує чоловіка в щоку.',
    1,
    NULL,
    1
  );
...
VALUES (
    15,
    'Тримаючи в руках долоню дівчини і дивлячись їй в обличчя, чоловік зізнається, яка частина її тіла окрім очей здається йому найбільш привабливою, як він хотів би ніжно та пристрасно цілувати та пестити її. На подяку за сміливість і одкровення дівчина нагороджує його поцілунком у губи.',
    1,
    NULL,
    1
  );
...
VALUES (
    16,
    '"Ніжний танець двох змійок", - так можна назвати це завдання. Тримаючи руки один у одного на талії і не торкаючись губами, ви граєте мовами, наче роблячи незвичайний французький поцілунок. При цьому можна змінюватися активною роллю, так вийде цікавіше. Наприклад, спочатку провідну роль грає дівчина, обвиваючись своєю мовою навколо чоловічої, а потім це робить джентльмен.',
    1,
    NULL,
    1
  );
...
VALUES (
    17,
    'Танцюючи повільний танець під романтичну музику, ви тісно притискаєтесь і пестите один одного. Чоловік чуттєво цілує дівчину в шию, гладить їй спину, стегна, попочку, а вона ніжно обіймає його, потираючи грудьми та животом. Все це робиться так, щоб ласки були дуже чуттєвими та приємними для обох із вас, збуджуючи та викликаючи бажання. Закінчивши танець, дівчина цілує чоловіка в губи, давши трохи посмоктати свій язичок.',
    1,
    NULL,
    1
  );
...
VALUES (
    18,
    'Намагаючись робити все максимально еротично, той, хто фантує, з''їдає фрукт або насолоду, яку йому підбирає партнер. Що він уявить при цьому - його особиста справа, але виглядати все має гранично зухвало і відверто. Якщо другому гравцю сподобається така міні-вистава, він нагороджує «актора» ніжним поцілунком у губи.',
    1,
    NULL,
    1
  );
...
VALUES (
    20,
    'Взявши невеликий кубик льоду до рота, чоловік передає його до рота дівчині. За мить вона так само повертає його назад. І так таз щоразу, поки кубик не розтане остаточно. Той, у кого він зник у роті, стає програвшим і знімає одну частину одягу. Але тільки ви обидва повинні чинити чесно!',
    1,
    NULL,
    1
  );
...
VALUES (
    24,
    'Заплющивши очі і розслабившись, фантуючий розповідає, як би він хотів зайнятися любов''ю на природі з другим гравцем, докладно зупиняючись на описі місця, дійства, емоціях та відчуттях. Слухаючи це захоплююче оповідання, партнер може запитувати, доповнювати його, коментувати та висловлювати побажання. Після того, як розповідь завершиться, ви міняєтеся ролями, і тепер фант перетворюється на уважного слухача, а другий гравець занурюється у свої відверті фантазії. "Повернувшись на землю", ви ніжно цілуєтеся в губи і знімаєте один з одного по одній частині одягу.',
    1,
    NULL,
    1
  );
...
VALUES (
    25,
    'Той, хто фанує цілу хвилину ніжно грає з нижньою губою партнера. Спочатку, подразнюючи і трохи торкаючись, кілька разів проводить по ній самим кінчиком своєї мови, а потім лагідним вампірчиком посмоктує, смикає і покусує її своїми губами. Потім та ж гра повторюється з верхньою губою, а на завершення ще раз з тією, якою все це найбільше сподобалося. Якщо «вампірчик» приніс задоволення, його гладять по голівці.',
    1,
    NULL,
    1
  );
...
VALUES (
    27,
    'Дівчина, дивлячись у вічі чоловікові, з''їдає банан. Вона робить все не поспішаючи і дуже еротично, щиро насолоджуючись своєю грою. Після цього чоловік дає їй запити ці ласощі ковтком вина зі свого рота.',
    1,
    NULL,
    1
  );
...
VALUES (
    29,
    'Замість того, щоб включати кондиціонер, ви знімаєте один з одного по одній частині одягу і продовжуєте далі цю захоплюючу гру.',
    1,
    NULL,
    1
  );
...
VALUES (
    30,
    'Дивлячись у вічі дівчині, чоловік злизує з тильного боку її долоні крапельку шоколаду, джему чи меду. Він робить все повільно та дуже еротично, щиро насолоджуючись власною грою. Після цього дівчина дає йому запити ці ласощі ковтком вина зі свого рота.',
    1,
    NULL,
    1
  );
...
VALUES (
    32,
    'Секс і свобода, розкутість та комплекси, умовності та вседозволеність. Не особливо захоплюючись, але й не стримуючись, п''ять хвилин, що фантує, філософствує на цю актуальну зараз тему.',
    1,
    NULL,
    1
  );
...
VALUES (
    33,
    'Дівчина пристрасно і чуттєво цілує чоловіка в губи, дозволяючи йому ніжно посмоктати свій язичок.',
    1,
    NULL,
    1
  );
...
VALUES (
    35,
    'Фантуючий докладно розповідає, яка обстановка йому здається найромантичнішою і схильною до інтимних відносин, детально описуючи меблі, елементи інтер''єру, колір, запахи, звуки... Після цього другий гравець продовжує його розповідь, все більше наповнюючи відчуттям еротики цей віртуальний «куточок кохання». Удвох ви ніби готуєте місце для свого наступного романтичного побачення. Поцілувавши один одного в носик, ви продовжуєте гру.',
    1,
    NULL,
    1
  );
...
VALUES (
    37,
    'Насолоджуючись чуттєвістю, ви зливаєтеся у одкровенні тантричного поцілунку. Сидячи на колінах свого партнера і ніжно дивлячись йому в очі, дівчина розчиняється в його подиху, вдихаючи на його видиху та видихаючи на вдиху. Не припиняючи дихати на цій хвилі, вона дарує йому довгий поцілунок, насолоджуючись таким чуттєвим єднанням.',
    1,
    NULL,
    1
  );
...
VALUES (
    38,
    'Відкинувшись у кріслі з келихом вина, той, хто фантує, розповідає про історію свого життя, коли йому дуже хотілося сексу з тією людиною, якій ніяк не можна було цього запропонувати. Хотілося шалено, мріялося теж, навіть снилося іноді, але не можна було і все! Можливо, це була вчителька (вчитель) чи дружина найближчого друга (чоловік подруги), сестра чи брат, нарешті. При цьому всі муки та сумніви описуються дуже докладно та відверто, а на запитання даються вичерпні відповіді.',
    1,
    NULL,
    1
  );
...
VALUES (
    39,
    'Гравці по черзі розповідають, від чого вони відчувають найбільше задоволення, чим найбільше хотілося б займатися за можливості, радіючи та насолоджуючись життям. Починає дівчина. Розцінивши розповіді як тост, ви випиваєте з рота один одного по ковтку вина за виконання бажань і продовжуєте гру далі.',
    1,
    NULL,
    1
  );
...
VALUES (
    40,
    'Занурившись у спогади, той, хто фантазує, розповідає про найнезвичайніший і яскравіший еротичний сон свого життя. Розповідає про деталі, барвисто описує почуття та переживання, подаровані іншим виміром. Ким він був, жінкою чи чоловіком, що дозволяв собі, і що витворювали з ним, як було страшно, солодко чи боляче. Зізнається, чи хотілося йому потім, може таємно або в іншому житті випробувати наяву все, що мріє.',
    1,
    NULL,
    1
  );
...
VALUES (
    41,
    'Фантуючий вголос мріє про те, як, насолоджуючись життям і коханою людиною, він провів би медовий місяць, не маючи жодних турбот і розпоряджаючись світом з власної забаганки. Його віртуальний бюджет не лімітований, а кордонів або відстаней не існує. Випивши з рота один одного по ковтку вина за втілення фантазій, ви продовжуєте гру далі.',
    1,
    NULL,
    1
  );
...
VALUES (
    43,
    'Фантуючий акуратно намазує губи другого гравця чимось солодким (шоколадом, медом, джемом...), а сам раптом стає жадібною «бджілкою», яка ніяк не може спокійно пролетіти повз такий привабливий здобич. Якщо бджілка була гарненькою, то її гладять по голівці.',
    1,
    NULL,
    1
  );
...
VALUES (
    44,
    'Чуттєво цілуючи дівчині шию, чоловік дарує їй настільки незвичайний, але шалено приємний «ланцюжок». Доповнивши її віртуальним колечком, він ніжно цілує панянку пальчик і, з любов''ю дивлячись їй у вічі, каже вишуканий комплімент.',
    1,
    NULL,
    1
  );
...
VALUES (
    45,
    'Дівчина відверто згадує, коли у неї буквально перехопило подих і затремтіли коліна від сексуального бажання побачивши чоловіка. Хто це був, коли таке сталося і в якійсь зупинці. Чи вдалося потім завести з ним роман, а може, просто інтрижку чи пристрасний порив так і розтанув з часом?',
    1,
    NULL,
    1
  );
...
VALUES (
    46,
    'Фантуючий розповідає коли, коли доби він зазвичай відчуває найбільше сексуальне бажання і коли б вважав за краще займатися сексом якби це залежало тільки від нього.',
    1,
    NULL,
    1
  );
...
VALUES (
    47,
    'Стаючи модельєром закритого еротичного клубу, чоловік віртуально одягає (роздягає) жінок, що прийшли на неї, в момент, коли вечірка вже в розпалі. Захоплюючись подробицями, він детально описує тонкощі та нюанси їхнього гардеробу, підбираючи його з урахуванням особливостей фігур. Типажі і комплекція жінок можуть бути різними, а специфіка клубу нічим не обмежує перекрученість відвідувачів. Багато хто з них у масках і, будучи інкогніто, насолоджуються абсолютною вседозволеністю. Оцінивши розповідь джентльмена, дівчина доповнює його фантазії, представивши себе в ролі однієї з таких відвідувачок і докладно описавши власний гардероб.',
    1,
    NULL,
    1
  );
...
VALUES (
    48,
    'Цілу хвилину чоловік ніжно покусує і цілує дівчині спочатку одне, а потім інше вушко, розповідаючи, якими дивно смачними вони виявилися. Поцілувавши потім мочки вух, чоловік дарує їй настільки незвичайні, але дуже приємні «сережки». Доповнивши їх віртуальним кулончиком, він ніжно цілує панянку посередині грудей і, з любов''ю дивлячись у вічі, каже їй вишуканий комплімент.',
    1,
    NULL,
    1
  );
...
VALUES (
    49,
    'Той, хто фанує гранично відверто розповідає, чи подобається йому порно і якщо так, то - яке. Він докладно описує, у чому йому межа між еротикою і порнографією і який витвір мистецтва цього жанру він запам''ятав найбільше (живопис, графіка, постановка, фільм, розповідь...). Послухавши все це, другий гравець теж стає відвертим і чесно зізнається, що відчуває, підглядаючи, як інші займаються сексом.',
    1,
    NULL,
    1
  );
...
VALUES (
    51,
    'Заплющивши очі і розслабившись, дівчина дуже докладно описує яким у неї буває оргазм. При цьому вона із задоволенням згадує, що відчуває під час його наближення, з чого він поступово починається, як розвивається, які відчуття виникають у неї внизу живота, в промежині, яким бурхливим він буває в неї, яким різним. Після цього ви не поспішаючи і чуттєво по черзі знімаєте один з одного по одній частині одягу. Першою з чоловіка знімає одяг дівчина.',
    2,
    NULL,
    1
  );
...
VALUES (
    55,
    'Тримаючи долоню другого гравця і дивлячись у вічі, фантующий відверто розповідає, що йому найбільше подобається в сексі, які пози, рухи, ласки, що він особливо любить робити сам і що любить отримувати від партнера. Потім він відвертає, якій ролі воліє при цьому пасивну чи активну, чи любить домінувати чи жорстко підкоряти, а, можливо, ще не практикував такого, але в таємниці мріє спробувати. Другий гравець без сорому може ставити йому будь-які питання, що уточнюють. Потім ви міняєтеся ролями, і тепер відверто вже другий гравець, афантуючий вивідує у нього пікантні подробиці. Закінчивши розмову на таку цікаву тему, ви ніжно цілуєтеся в губи і знімаєте один з одного по одній частині одягу. Як перший роздягає виступає фантующий.',
    2,
    NULL,
    1
  );
...
VALUES (
    57,
    'Танцюючи удвох повільний танець, ви не поспішаючи і чуттєво роздягаєте один одного до трусиків, по черзі знімаючи з партнера по одній частині одягу і щоразу цілуючись у губи. Першим починає роздягати партнерку джентльмен. Той, хто виявиться роздягнений до трусиків першим, на свій вибір одягає еротичний костюм (якщо такі є).',
    2,
    NULL,
    1
  );
...
VALUES (
    59,
    'Танцюючи повільний танець під романтичну музику, ви повільно і чуттєво роздягаєте один одного. Спочатку одну частину одягу з чоловіка знімає дівчина, а потім одну з дівчини - чоловік, потім ви цілуєтесь, і так щоразу, поки дівчина не вирішить зупинитися або один з вас не виявиться повністю оголеним. Після цього дівчина цілує чоловіка в губи, давши трохи посмоктати язичок, і вибирає наступний фант.',
    2,
    NULL,
    1
  );
...
VALUES (
    66,
    'Чоловік дуже переконливо розповідає дівчині, чому їм неодмінно слід зайнятися сексом саме сьогодні. Якщо вони спробують відкласти його до наступного побачення, те, що поганого він бачить у цьому.',
    2,
    NULL,
    1
  );
...
VALUES (
    68,
    'Граючи, ви не поспішаючи роздягаєте один одного до трусиків, по черзі знімаючи з партнера по одній частині одягу та роблячи приємні компліменти. Першим починає роздягати партнерку джентльмен. Потім дівчині зав''язуються очі і вона, розслабившись, лягає на живіт у передчутті райської насолоди. Чоловік, використовуючи спеціальну олію, робить їй чуттєвий еротичний масаж, ніжно пестячи руками її тіло. Через десять хвилин він перевертає панночку на спину, продовжуючи свій вишуканий масаж. Подякувавши чоловіку ніжним поцілунком у губи, дівчина обирає наступне завдання.',
    2,
    NULL,
    1
  );
...
VALUES (
    70,
    'Граючи, ви роздягаєтеся до трусиків, по черзі знімаючи один з одного по одній частині одягу та роблячи приємні компліменти. Першою починає роздягати партнера дівчина. Потім чоловікові зав''язуються очі і він, розслабившись, лягає на живіт у передчутті неземної насолоди. Дівчина, використовуючи спеціальне масло, робить йому чуттєвий еротичний масаж, пестячи руками, розминаючи та погладжуючи. Потім, нахилившись, вона, трохи торкаючись шкіри, ніжно водить його тілом своїми сосочками і волоссям (якщо волосся довге). Через десять хвилин вона перевертає джентльмена на спину, продовжуючи свій чудовий масаж.',
    2,
    NULL,
    1
  );
...
VALUES (
    78,
    'У цьому змаганні немає переможців, але все ж таки цікаво з''ясувати, хто з вас знає більше видів поцілунку в губи. Все має бути дуже неформальним, просто опис поцілунку або його непереконливе виконання не зачитуються. Сподобатися обов''язково вам обом, а поспішати вкрай не рекомендується. Ніжно цілуючи партнера, починає фантируючий, а наступний поцілунок - за другим гравцем. І так, змінюючись, ви чесно і захоплено продовжуєте таке незвичайне змагання. Той, хто програв, отримує ляпас по попі, і переможець знімає з нього одну частину одягу.',
    2,
    NULL,
    1
  );
...
VALUES (
    80,
    'Раптом чомусь вийшло, що на одному з партнерів залишилося більше одягу!? З метою більшої справедливості роздягнений знімає одну частину одягу з другого гравця і замінює один жовтий фант у рожевому колоді.',
    2,
    NULL,
    1
  );
...
VALUES (
    83,
    'Тримаючи в руках долоню дівчини і дивлячись їй у вічі, чоловік дуже пристрасно та ніжно розповідає, як він хоче її. Він може обмежитися просто словами «Знала б ти, як я шалено хочу тебе», вимовленими максимально сексуально і щиро, а може спробувати знайти ще більш чуттєві слова. Якщо дівчина відчула легке запаморочення від цих зізнань, вона знімає з джентльмена одну частину одягу і цілує їх у губи.',
    2,
    NULL,
    1
  );
...
VALUES (
    84,
    'Той, хто фанує відверто розповідає, що йому з часом стало все більше подобатися в сексі з того, що раніше він вважав неприйнятним або збоченим. Другий гравець може розпитувати його, претендуючи на щирість та пікантні подробиці. Якщо розповідь фантуючого заслуговує на те, партнер нагороджує його ніжним поцілунком в губи і знімає з себе одну частину одягу.',
    2,
    NULL,
    1
  );
...
VALUES (
    85,
    'Відкривши трусики і, дивлячись собі між ніг, дівчина, не показуючи пальцем, намагається пояснити, де в неї знаходиться клітор. Роз''яснення робиться таким чином, щоб чоловік спробував з першого ж дотику доторкнутися до нього, відчувши кінчиком пальця цю чудову точку. Дівчина має бути по-справжньому чесною!!! Якщо цю нелегку вправу ви вдвох виконаєте з успіхом, то, ніжно поцілувавшись, знімаєте один з одного по одній частині одягу та продовжуєте гру. Першою дівчину роздягає чоловік.',
    2,
    NULL,
    1
  );
...
VALUES (
    90,
    'Сидячи на дивані і обійнявшись, ви гортаєте Каталог поз (за відсутністю даного каталогу можна скористатися підходящою літературою), розглядаючи та обговорюючи найбільш незвичайні з них і сподобалися. Кожен показує, що особисто його приваблює найбільше і пояснює чому. Моделюючи ситуацію, разом міркуєте, з якого становища в яке найзручніше було б перейти. Потім спочатку дівчина, а після джентльмен вибирають, які пози для них у каталозі нові, і що дуже хотілося б спробувати. Жаль, що на вас залишилося так багато одягу. Щоб виправити це, чоловік знімає з дівчини одну частину одягу, а потім вона з нього одну. Замінивши три жовті фанта в рожевій колоді, ви продовжуєте гру. А може краще разом у ванну, а потім – «рожева» гра?',
    2,
    NULL,
    1
  );
...
VALUES (
    91,
    'Знявши з другого гравця будь-яку одну частину одягу, він робить йому трихвилинний масаж сідниць.',
    2,
    NULL,
    1
  );
...
VALUES (
    92,
    'Уявивши собі, що великий палець руки чоловіка зовсім не палець, дівчина бере його в рот і дражнить джентльмена, заводячи його своєю грою. Якщо він правильно поводитиметься і далі, він має шанс випробувати це «по-дорослому». Дівчина чесно зізнається, що треба робити для цього.',
    2,
    NULL,
    1
  );
...
VALUES (
    93,
    'Фантуючий зізнається, які дві секс-іграшки він попросив узяти з собою другого гравця на наступне побачення, якби гру їм довелося припинити прямо зараз. На прохання партнера він пояснює, навіщо такі іграшки будуть потрібні. Якщо другий гравець поділяє побажання фантуючого, він знімає одну частину одягу. Якщо ні (але чесно), то, знявши одну частину одягу, роздягається фантующий.',
    2,
    NULL,
    1
  );
...
VALUES (
    94,
    'Знявши з фантуючого одну частину одягу, другий гравець вибирає, яку оголену частину його тіла хоче ніжно і пристрасно поцілувати. Дивлячись у вічі фантующему, він пояснює, чому саме це місце йому хочеться поцілувати зараз, а потім насолоджується поцілунком.',
    2,
    NULL,
    1
  );
...
VALUES (
    95,
    'Фантуючий розповідає, яка родимка або шрамчик на його тілі здаються йому найбільш еротичними і дозволяє другому гравцю, діставшись цього затишного містечка, ніжно поцілувати його.',
    2,
    NULL,
    1
  );
...
VALUES (
    97,
    'Молода незаймана кузина приїхала в гості до дівчини, а її старий друг раптом закохався і шалено прагне сексу нею. Він просить дівчину допомогти схилити свою родичку інтимні стосунки з ним. Уявивши собі таку картинку, а кузину в особі партнера по грі, дівчина намагається переконливо роз''яснити йому всю красу сексу і безглуздість подальшої помірності. Увійшовши у роль незайманої дівчини, чоловік може боятися і сумніватися, а дівчина неодмінно повинна «вламати його». Нарешті піддавшись на вмовляння, але, все-таки ще трохи соромлячись, чоловік дозволяє роздягнути себе так, як того забажає дівчина, а потім роздягає її до такого ж стану.',
    2,
    NULL,
    1
  );
...
VALUES (
    98,
    'Ледве прикрите жіноче тіло нерідко збуджує чоловіків більше наготи, розпалюючи уяву і хвилююча відчуттям передчуття. Ледве розсунувши ніжки, дівчина дозволяє чоловікові крізь трусики ніжно погладити пальцем свою промежину. Легкими дотиками він ковзає вниз, відчуваючи перехід лобка в статеві губи, відчуваючи їх хвилюючі контури ... Дівчина вибирає будь-який наступний фант або приймає рішення про перехід до «рожевої» гри.',
    2,
    NULL,
    1
  );
...
VALUES (
    102,
    'Дівчина, заплющивши очі і розслабившись, лягає на живіт, трохи розсунувши ніжки. Чоловік, використовуючи спеціальну олію, робить їй чуттєвий еротичний масаж, десять хвилин ніжно пестячи руками оголене тіло. Використовувати при цьому язик чи губи суворо забороняється! Особливу увагу він приділяє найчутливішим ерогенним зонам, про які вже дізнався у процесі гри. Масаж завершується ніжним поцілунком дівчини у шию, і вона вибирає будь-який наступний фант.',
    3,
    NULL,
    1
  );
...
VALUES (
    103,
    'Чоловік відкидається у кріслі із зав''язаними очима, злегка розсунувши ноги та поклавши руки за голову. Дівчина, пірнувши язичком у глибину його рота, пристрасно цілує чоловіка в губи, а потім починає свої ласки. Використовуючи масажне масло, вона п''ять хвилин ніжно і неквапливо пестить руками його мошонку, член, ласкаво перебирає пальцями яєчка, губами дражнить головку, що напружилася. Нарешті вона ніжно цілує його спочатку в одне, а потім інше яєчко і припиняє свою солодку тортуру.',
    3,
    NULL,
    1
  );
...
VALUES (
    106,
    'Дівчина бере стрічку (краватку, п''ятисотеврову купюру...) і, поцілувавши член чоловіка, зав''язує на ньому витончений бантик. Цей дивовижно привабливий бантик красується там у процесі виконання всього наступного фанта, який вибирає панночка.',
    3,
    NULL,
    1
  );
...
VALUES (
    108,
    'Чоловік, повністю розслабившись і заплющивши очі, лягає на живіт, трохи розсунувши ноги, а дівчина, використовуючи масажне масло, робить йому ніжний і чуттєвий еротичний масаж. Почавши робити масаж руками, вона потім схиляється над чоловіком зверху і, ковзаючи вздовж, масажує його своїм оголеним тілом, спочатку ледве торкаючись тільки кінчиками сосків, потім усіма грудьми, животом, лобком, ногами, з кожним разом все тісніше і тісніше притискаючись до нього. ..',
    3,
    NULL,
    1
  );
...
VALUES (
    111,
    'Чоловік лягає на спину із зав''язаними очима, повністю розслабившись у передчутті насолоди і трохи розсунувши ноги. Дівчина десять хвилин ніжно пестить його оголене тіло, використовуючи спочатку хутро (рукавичку, пензлик) або пір''їнку, а потім, схилившись, – своє волосся. Трохи допомогти губами або язичком - можна, але робити щось руками суворо заборонено! Особливу увагу панночка приділяє найбільш чутливим ерогенним зонам джентльмена, про які, можливо, вже знає з розіграшу попередніх фантів.',
    3,
    NULL,
    1
  );
...
VALUES (
    114,
    'Чоловік сідає на ліжко, схрестивши перед собою ноги та поклавши на них подушку. Дівчина лягає на спину головою до нього, поклавши голову на цю подушку і повністю розслабившись із заплющеними очима. Змастивши руки масажним ароматом, чоловік ніжно і не поспішаючи починає масажувати панянки груди. Як можна чуттєвіше і м''якше охоплюючи долонею, гладить, пестить і переминає її. Трохи торкаючись кінчиками пальців, або, навпаки, злегка пощипуючи, він грає з сосочками, дражнячи та збуджуючи їх. Разом ви щиро насолоджуєтесь цим дійством, стаючи дедалі ближче один до одного. Вважаючи, що час завершувати масаж, панночка вибирає будь-який наступний фант.',
    3,
    NULL,
    1
  );
...
VALUES (
    116,
    'Чоловік із зав''язаними очима лягає на спину, трохи розсунувши ноги та розслабившись у передчутті задоволення. Використовуючи спеціальне масло, дівчина робить йому ніжний та чуттєвий еротичний масаж. Почавши робити масаж руками, вона потім схиляється над чоловіком зверху і, ковзаючи вздовж, масажує його своїм оголеним тілом, спочатку ледве торкаючись тільки кінчиками сосків, потім усіма грудьми, животом, лобком, ногами, з кожним разом все тісніше і тісніше притискаючись до нього. ..',
    3,
    NULL,
    1
  );
...
VALUES (
    119,
    'Чоловік сідає з краю ліжка, опустивши ноги на підлогу. Розташувавшись спиною до нього, дівчина так само сідає на ліжко між ніг чоловіка. Притулившись до спини дівчини грудьми і обхопивши спереду, він обіймає та пестить її двома руками. Чіпає, гладить і переминає груди, ніжно пощипує і смикає сосочки. Плавно опускаючись вниз, чуттєво погладжує животик і стегна, трохи масажує долонями лобок. Полащавши внутрішній бік стегон, повільно просувається до промежини. Ніжно проводячи кінчиками пальців по пахвинних складочках, статевих губках, поступово добирається до клітора, пестячи і смикаючи його. Розсунувши вже набряклі губи, пірнає одним пальцем у вологу глибину, а другим продовжує пестити клітор, доводячи дівчину до тремтіння. Цілуючи її ззаду в шию, нашіптує на вушко лагідні слівця, поки панночка не захоче вибрати наступний фант.',
    3,
    NULL,
    1
  );
...
VALUES (
    123,
    'Чоловік сідає у крісло, розсунувши ноги, і докладно розповідає дівчині, які оральні ласки йому подобаються найбільше. При цьому він дуже відверто зупиняється на всіх найважливіших деталях і дає пояснення. Закінчивши розповідь, він відкидається в кріслі, а дівчина встає на коліна і намагається довести його до стану блаженства, дотримуючись почутих побажань. Діючи губками і язичком, вона одночасно з цим пестить пальцями яєчка і ніжно гладить промежину, трохи подразнюючи вхід в анус. Якщо у пані щось не зовсім виходить, джентльмен допомагає виправити помилки, підказуючи, допомагаючи або направляючи рукою її голову. Якщо "учениця" виявилася здатною, вона нагороджується правом вибрати наступний фант.',
    3,
    NULL,
    1
  );
...
VALUES (
    128,
    'Говорять у деяких дівчат у піхву дійсно є точка G. Раптом і у присутньої панночки теж. Дуже важливо негайно перевірити це, по можливості максимально точно визначившись з її місцезнаходженням. Дівчина сідає на край ліжка або у крісло, широко розсунувши ніжки. Чоловік стає на колінах у неї між ніг і під чуйним керівництвом проводить свій захоплюючий пошук. Розігрівши для початку вхід у піхву язиком, він обережно вводить туди свій змащений палець і починає шукати «чарівну кнопку». Намагаючись не втрачати контролю, дівчина намагається «керувати процесом», підказуючи напрямок руху, силу тиску і частоту вібрацій пальця дослідника. Спільними зусиллями ви знаходите місце, що шукається і, «відзначивши його фломастером», продовжуєте гру.',
    3,
    NULL,
    1
  );
...
VALUES (
    134,
    'Дівчина відверто розповідає, чи може вона випробувати оргазм лише шляхом власних ласок або за допомогою партнера, але без безпосереднього генітального сексу. Якщо так, то за рахунок чого і як це відбувається, що їй подобається при цьому найбільше. Чоловік нагороджує її за відвертість довгим ніжним поцілунком, а якщо це так і панночка згодна, ви намагаєтеся втілити її розповідь у реальність. Дівчина обирає будь-який наступний фант або приймає рішення про перехід до «червоної» гри.',
    3,
    NULL,
    1
  );
...
VALUES (
    135,
    'У передчутті насолоди дівчина із зав''язаними очима розслаблено лежить на спині, трохи розсунувши ніжки. Використовуючи масажну олію, чоловік десять хвилин робить їй вишуканий еротичний масаж. Відчувши збудження дівчини, він, трохи торкаючись, починає пестити подушечкою пальця її клітор, відчуваючи, як той тремтить і напружується у відповідь. Як тільки соки дівчини зволожать другий його палець, чоловік обережно і повільно вводить його в піхву, продовжуючи там свій ніжний масаж. Наступний фант розігрується на вибір дівчини.',
    3,
    NULL,
    1
  );
...
VALUES (
    137,
    'Схід надає величезного значення позиції 69. Це не просто секс, а дуже тонкий і чуттєвий обмін сексуальною енергією. Принципово важливим є ставлення до самого дійства. Налаштуйтеся на почуття взаємного злиття, повністю розчинившись у насолоді процесом та один одним. Не ставтеся до цієї позі як до прелюдії, адже вона абсолютно самодостатня. Насолоджуйтесь партнером, «пийте» його тремтіння, відчувайте пульсації плоті, і гострота оргазму, що прийшов, захопить вас обох. Почніть з положення на боці, зручно та розслаблено розташувавшись між ніг один одного. Трохи підібгавши верхню ногу, покладіть її на плече партнера, а, пропустивши верхню руку під стегно, що лежить на плечі, дотримуйтесь за його сідницю. Втім, все має бути просто зручно і тоді захоплення насолодою вам гарантовано. За бажання переходьте до «червоної» гри.',
    3,
    NULL,
    1
  );
...
VALUES (
    142,
    'Приготувавши анальні намисто, ви починаєте розігрівати один одного в позиції "69 чоловік знизу". Для зручності під голову джентльмен підкладається валик або подушка. Для початку займаєтесь оральним сексом, щиро насолоджуючись один одним. Потім переключаєте всю увагу на ануси, пестячи їх язиками та пальцями. Як слід розігрів їх, не поспішаючи і обережно, кульку за кулькою вводите один одному анальні намисто. Виймаючи і знову вставляючи намисто, граєте гостротою своїх відчуттів, ні на хвилину не припиняючи пестити один одного губами та язиками. Чоловік ухвалює рішення про перехід до «червоної» гри, і дівчина обирає наступний фант.',
    3,
    NULL,
    1
  );
...
VALUES (
    149,
    'Дівчина вибирає собі фалоімітатор або вібратор, а чоловік - анальну вібропробочку, після чого ви починаєте пестити один одного мовами в позиції "69 чоловік зверху". Для початку займаєтеся оральним сексом, щиро насолоджуючись і намагаючись зробити якомога більше задоволення один одному. Потім чоловік плавними поштовхами занурює у піхву дівчини змащений фалоімітатор, а вона обережно і повільно вводить йому в анус добре змащену проби. Увімкнувши вібрацію, і продовжуючи пестити один одного мовами, ви десять хвилин насолоджуєтеся незвичайною гостротою своїх відчуттів. Вибравши будь-який червоний фант, дівчина переводить гру у «червоний» формат.',
    3,
    NULL,
    1
  );
...
VALUES (
    151,
    'Поза 01. Якщо у вас є крісло-гойдалка, то не варто використовувати його тільки для обідньої дрімоти. Хто сказав, що це його головне призначення? Але тільки захопившись експериментами, постарайтеся не наїхати собі на пальці ніг, ерекція пропадає миттєво! Дотримуючись один за одного і розгойдуючись, ви можете влаштувати собі чудовий атракціон, головне сміливіше експериментувати. Якщо у показаній позиції чоловік підтримуватиме дівчину, накинувши їй на шию шовковий шарф (або свою краватку), вона зможе повністю розслабити спину, віддавшись дивовижним відчуттям «дівчата на дорослих гойдалках».',
    4,
    '/img/1.jpg',
    1
  );
...
VALUES (
    152,
    'Пози 02, 03 і 04. Незважаючи на екзотичність, що здається, позиція № 2 цілком зручна до виконання, якщо дівчина не дуже щільно поїла перед побаченням. Унікальність перевернутих поз полягає в тому, що додаткове почуття «ульоту» викликається припливом крові до голови, а оргазм у жінок в такому положенні яскравіший. Головне при цьому повністю розслабитися і поринути в насолоду незвичністю. Усвідомлювати те, що відбувається, має виключно чоловік, місце панянки - на небесах. Почавши з позиції № 2, чоловік повільно опускає дівчину на спину (поза № 3), а через деякий час може перейти в більш комфортне положення № 4.',
    4,
    '{/img/2.jpg, /img/3.jpg, /img/3.jpg',
    1
  );
INSERT INTO "alltasks"
VALUES (
    153,
    'Дівчині дозволяється робити абсолютно все, що вона забажає у сексі. Давати завдання чоловікові, вибирати та змінювати ролі, пози та техніку, використовувати секс-іграшки та пристосування, намагаючись при цьому не завдати шкоди нічиєму здоров''ю. У її розпорядженні надаються всі можливості та резерви студії, включаючи меблі та аксесуари. Дівчина повноцінно творить у ній, намагаючись реалізувати всі свої таємні, хай навіть збочені фантазії. При цьому вона може вигадувати пози сама, так і користуватися Каталогом. Чоловік беззаперечно дотримується всіх вказівок і побажань панночки, в жодному разі не закінчуючи без її дозволу. Якщо це все ж таки відбудеться раніше часу, то він зобов''язаний, відновивши свої сили, знову повністю віддатися у владу дівчини.',
    4,
    NULL,
    1
  );
...
VALUES (
    156,
    'Пози 05 і 06. Незвичайний кут введення члена, сильне розтягнення в паху і тісний дотик промежин у позі № 5 викликають дуже приємні відчуття обох партнерів. Змінюючи кут нахилу над дамою, що відкинулася, напрям, силу і інтенсивність поштовхів, джентльмен має прекрасні можливості для справжньої творчості. Свобода рук надає додаткові можливості для ласок, а, взявши в рот пальчик ноги панночки, чоловік може доводити її до трепету своєю грою. Щодо цього поза №5 унікальна. Перекинувши нижню ніжку панночки нагору і схрестивши її з верхньої, чоловік піднімається навпочіпки і переходить у позицію № 6 («позу, подібну до лотоса»), яка є справжнім шедевром східного мистецтва кохання.',
    4,
    '{/img/5.jpg, /img/6.jpg}',
    1
  );
...
VALUES (
    165,
    'На вибір дівчини наступну гру вони проведуть утрьох чи вчотирьох, одягнувши за бажання маски. Панночка сама запропонує комусь із членів Клубу «Фанти» приєднатися до них. Гра проводитиметься до «червоного» формату, а якщо при цьому буде потрібний призовий фонд, то фінансування забезпечить чоловік. Наступний фант вибирає дівчина.',
    4,
    NULL,
    1
  );
...
VALUES (
    173,
    'Пози 23 і 24. Поєднання цих двох незвичайних поз надає дівчині можливість справжнього сексуального творчості. Довівши губками член чоловіка до граничної ерекції, вона с. насолодою насаджується на нього в позицію № 23. Розташовуючись зверху під кутом і дотримуючись за ноги джентльмена, панночка має чудову нагоду почуватися справжньою амазонкою, що осідлала «гарячого жеребця». Змінюючи інтенсивність рухів та кут нахилу тіла, вона тонко диригує відчуттями обох. Остаточно підпорядкувати собі чоловіка наїзниця може у позиції № 24, коли він повністю перебуває у її безроздільній владі. За допомогою чоловіка вона змінює пози, не роз''єднуючись із ним. Скінчивши або знесилені, дівчина може плавно опуститися на спину, поступившись активною роллю джентльмену.',
    4,
...
VALUES (
    174,
    'Пози 25 і 23. Надавши дівчині можливість панувати у цих двох позиціях, чоловік сам буде насолоджуватися, захоплюючись силою її емоцій. Сівши зверху обличчям до нього, вона, не роз''єднуючись, обережно витягує ноги, лягаючи в позицію № 25. Не дивлячись на невелику глибину проникнення, це положення дозволяє відчувати сильний тиск члена в області клітора та входу в піхву, даруючи справжню насолоду обом особливо панянки. Трохи вигинаючись, вона щільно притискає лобки, запобігаючи вислизу члена з піхви. Ще сильніше притягуючи дівчину за сідниці, чоловік допомагає їй тертися клітором об основу члена. Різкі рухи в цій позі не потрібні, надзвичайно приємне саме відчуття злиття. Якщо дівчина забажає більшої активності, то перехід у позицію №23 буде найкращим варіантом подальшого розвитку подій.',
    4,
    '{/img/25.jpg, /img/23.jpg}',
    1
  );
INSERT INTO "alltasks"
VALUES (
    175,
    'Поза 26. На перший погляд трохи акробатична поза № 26 цілком реалістична. Вона з тих, що вносять нові емоції в «постільну одноманітність життя». Додаткове розтягнення пахових м''язів у чоловіка поряд із сильним прогином спини та підвищеним тиском на верхню частину головки створюють у нього дуже незвичайні та приємні відчуття. У це становище дуже добре переходити з позиції «69 ​​жінка знизу» після того, як обидва партнери вже досить розігріті і просто прагнуть з''єднатися. Для більшої стійкості та комфортності пози дівчині варто упертися головною в спинку ліжка, а під сідниці їй можна додатково підкласти подушку або валик.',
    4,
    '/img/26.jpg',
    1
  );
...
VALUES (
    177,
    'Чоловік відносить дівчину в крісло або на стілець і кохається з нею таким чином і в таких позах, які йому самому найбільше подобаються. Урізноманітнюючи техніку сексу, змінюючи положення тіл, інтенсивність, силу і глибину любовних поштовхів, він щиро насолоджується дійством. Прислухаючись до прохань і побажань панночки, він намагається зробити їй максимальне задоволення і не кінчає без дозволу. Рішення про перехід до наступного фанта приймає дівчина.',
    4,
    NULL,
    1
  );
...
VALUES (
    195,
    'Пози 23 і 24. Дубль цих поз у поєднанні анального сексу з віброкульками може привести дівчину в захват. Лащачи панночку зверху в позиції 69, чоловік для початку ретельно готує її до майбутнього чудового дійства. Розігрівши кінчиком язика і пальцем її анус, він потім вводить дівчині у піхву віброкульки і лягає на спину. Повільно і обережно насадившись попочкою на член чоловіка в положення № 23, панночка включає вібрацію кульок. Самозабутньо насолоджуючись незвичайними відчуттями, вона щиро впивається дійством, тоді як чоловік пестить її руками, обсипаючи захопленими компліментами.',
    4,
    '{/img/23.jpg, /img/24.jpg}',
    1
  );
...
VALUES (
    196,
    'Не роз''єднуючись із чоловіком, вона може перекинути вперед його ногу і, осідлавши в позиції № 24, продовжити свою дивовижну гру.',
    4,
    '/img/24.jpg',
    1
  );
